...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link
        href="https://fonts.googleapis.com/css2?family=Verdana&family=Open+Sans:ital,wght@0,300;0,400;0,600;0,700;0,800;1,300;1,400;1,600;1,700;1,800&display=swap"
        rel="stylesheet">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="popup-btn">
                                <a href="javascript:" class="btn gallery-btn-green" onclick="myFunction()">Artist
                                </a>
                                <span>OR</span>
                        ...
                        <div class="col-lg-12">
                            <div id="popup-option">
                                <a href="{{ url('posts/create/artist') }}"
                                    class="btn gallery-btn-dark-yellow">Personal</a>
                                <span>OR</span>
                                <a href="{{ url('posts/create/commissioner') }}"
                                    class="btn gallery-btn-dark-yellow">Commissioned</a>
                            </div>
                        </div>
                    </div>
                </div>
