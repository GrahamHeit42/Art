                ...
                <div class="card-body">
                    <form name="page-form" id="page-form" action="{{ url('admin/pages/store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title" class="form-control" value="{{ $page->title ?? NULL }}"/>
                        </div>
                        <div class="form-group">
                            <label for="content">Content</label>
                            <textarea id="content" name="content" class="form-control" rows="15">{{ $page->content ?? NULL }}</textarea>
                        </div>
