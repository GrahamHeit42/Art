    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card card-primary">
                ...
                <form class="form-horizontal" id="validateForm" method="POST" action="{{ url('userSave') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group row col-md-12">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" name="email" value="{{$user->email ?? old('email') ?? ''}}" class="form-control {{ $errors->has('email') ? 'border-danger' : ''}}" @if(isset($user->email)) readonly @endif />
                            ...
                            <div class="form-group row col-md-12">
                                ...
                                <div class="col-sm-10">
                                    <select name="is_admin" id="is_admin" class="form-control">
                                        <option value="1" <?php if (isset($user) && $user->is_admin == '1') echo 'selected=selected'; ?>>Admin</option>
                                        <option value="0" <?php if (isset($user) && $user->is_admin == '0') echo 'selected=selected'; ?>>User</option>
                                    </select>
                            ...
                            <div class="form-group row col-md-12">
                                ...
                                <div class="col-sm-10">
                                    <select name="status" id="status" class="form-control">
                                        <option value="0" <?php if (isset($user) && $user->status == '0') echo 'selected=selected'; ?>>Pending</option>
                                        <option value="1" <?php if (isset($user) && $user->status == '1') echo 'selected=selected'; ?>>Active</option>
                                        <option value="2" <?php if (isset($user) && $user->status == '2') echo 'selected=selected'; ?>>Deleted</option>
                                        <option value="3" <?php if (isset($user) && $user->status == '3') echo 'selected=selected'; ?>>Suspended</option>
                    ...
                    <div class="card-footer">
                        <a href="{{url('usersList')}}"><input type="button" value="Back" class="btn btn-info float" /></a>
