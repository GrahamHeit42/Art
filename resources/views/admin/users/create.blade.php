...
<section class="content">
    ...
    <div class="card col-md-9 m-auto">
        ...
        <div class="card-body">
            <form class="form-horizontal" id="validateForm" method="POST" action="{{ url('users/save') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-sm-9">
                                ...
                                <button type="button" class="btn open-modal dlt-btn text-danger" data-id="{{$user->id}}"><i class="fas fa-trash"></i></button>
                                @else
