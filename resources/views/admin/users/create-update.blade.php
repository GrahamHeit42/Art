...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form name="user-form" id="user-form" action="{{ url('admin/users/store') }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <label>
                                    <input type="radio" id="status-inactive" name="status" value="0"
                                        {{ ($user->status ?? 0) === 0 ? 'checked' : '' }} /> Inactive
                                </label>
                                <label class="ml-3">
                                    <input type="radio" id="status-active" name="status" value="1"
                                        {{ ($user->status ?? 0) === 1 ? 'checked' : '' }}> Active
                                </label>
                                <label class="ml-3">
                                    <input type="radio" id="status-blocked" name="status" value="2"
                                        {{ ($user->status ?? 0) === 2 ? 'checked' : '' }}> Blocked
                                </label>
                            </div>
                        </div>
                    </div>
