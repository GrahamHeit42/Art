...
<div id="main">
    <div class="gallery">
                ...
                <div class="row no-spacing">
                    <div class="col-lg-12 col-md-12 no-spacing">
                        <div class="tab-button nav" id="nav-tab" role="tablist">
                            ...
                            <a class="btn gallery-btn-green" id="nav-3d-tab" data-toggle="tab" href="#nav-3d" role="tab" aria-controls="nav-3d" aria-selected="false">3D</a>
        ...
        <div class="post-btn nav" id="nav-tab" role="tablist">
            <a class="btn gallery-btn-green" id="nav-filter-latest-tab" data-toggle="tab" href="#nav-filter-latest" role="tab" aria-controls="nav-filter-latest" aria-selected="false">Latest</a>
            <a class="btn gallery-btn-dark-yellow" id="filter-popular-tab" data-toggle="tab" href="#nav-filter-popular" role="tab" aria-controls="nav-filter-popular" aria-selected="false">Popular</a>
            <a href="#" class="btn gallery-btn-yellow">----</a>
        </div>
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="post tab-pane fade" id="nav-3d" role="tabpanel" aria-labelledby="nav-3d-tab">
                <div class="page-type">
                    ...
                    <a href="#" class="vertical">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-58.jpg')}}" />
                    </a>

                    <a href="#" class="small">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-59.jpg')}}" />
                    </a>

                    <a href="#" class="small">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-60.jpg')}}" />
                    </a>

                    <a href="#" class="small">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-61.jpg')}}" />
                    </a>

                    <a href="#" class="small">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-62.jpg')}}" />
                    </a>

                    <a href="#" class="small">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-63.jpg')}}" />
                    </a>

                    <a href="#" class="vertical">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-64.jpg')}}" />
                    </a>

                    <a href="#" class="horizontal">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-65.jpg')}}" />
                    </a>

                    <a href="#" class="horizontal">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-66.jpg')}}" />
                    </a>

                    <a href="#" class="small">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-67.jpg')}}" />
                    </a>

                    <a href="#">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-68.jpg')}}" />
                    </a>

                    <a href="#" class="horizontal">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-69.jpg')}}" />
                    </a>
            ...
            <div class="post tab-pane fade" id="nav-filter-latest" role="tabpanel" aria-labelledby="nav-filter-latest-tab">
                <div class="page-type">
                    <a href="#" class="vertical">
                        <img class="animate__animated animate__zoomIn" src="{{asset('images/gallery/post-56.jpg')}}" />
                    </a>
