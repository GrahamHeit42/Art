...
<div class="gallery">
    ...
    <div class="filter">
        <div class="post nav" id="nav-tab" role="tablist">
            <a class="button btngreen" id="nav-filter-latest-tab" data-toggle="tab" href="#nav-filter-latest" role="tab"
                aria-controls="nav-filter-latest" aria-selected="false">Latest</a>
            <a class="button btnyellow" id="filter-popular-tab" data-toggle="tab" href="#nav-filter-popular" role="tab"
                aria-controls="nav-filter-popular" aria-selected="false">Popular</a>
            <a class="button btndarkyellow" id="filter-trending-tab" data-toggle="tab" href="#nav-filter-trending"
        ...
        <div class="artsoption">
            <div class="commissions">
                ...
                <input class="commissions_input" type="radio" name="commissions" value="option1" id="commissionscheck"
                    checked>
            </div>
            <div class="mediums">
                <a class="meddropdown dropdown-toggle" type="button" id="mediumsdropdown" data-toggle="dropdown"
