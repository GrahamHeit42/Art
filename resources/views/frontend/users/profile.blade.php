            ...
            <div class="user-banner" style="background-image: url({{asset('assets/images/gallery/post-66.jpg')}});">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <div class="edit-user">
                            <a href="#" class="btn" data-target="#edit-profile" data-toggle="modal"><i
                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home"
                                    role="tab" aria-controls="nav-home" aria-selected="true">Bio</a>
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                                    role="tab" aria-controls="nav-profile" aria-selected="false">Profile Pic</a>
