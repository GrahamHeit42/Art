				...
				<div class="col-lg-6 artistcol">
					<div class="upload-info">
						...
						<div class="upload-btn-wrapper justify-content-center">
							<a class="btngreen btngreen-upload" onclick="mainUploadClick()">UPLOAD</a>

							<div id="add-more-div" class="text-center add-more-div" style="display: none;">
								<button type="button" id="add-more" class="btn btn-success" onclick="$('#post-images-1').click();">
									Add More
								</button>
							</div>
						</div>
					...
					<div class="row" style="display: none;" id="image-row-1">
						...
						<div id="add-more-div-1" class="text-center add-more-div">
							<button type="button" id="add-more" class="btn btn-success" onclick="addMoreFirst()">
								Add More
							</button>
						</div>
						{{-- <div id="add-more-div-1-2" class="text-center add-more-div" style="display: none;">
							<button type="button" id="add-more" class="btn btn-success"
								onclick="$('#image-row-2').show();$(this).parent().hide()">
								Add More
							</button>
						</div> --}}
					</div>

					<div class="row" style="display: none;" id="image-row-2">
						<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
							<div class="drop-zone" style="position: relative;">
								<span class="drop-zone__prompt">
									<button class="btn btn-info" type="button">Upload</button>
						...
						{{-- <div id="add-more-div-1" class="text-center add-more-div">
							<button type="button" id="add-more" class="btn btn-success"
								onclick="$('#image-row-3').show();$(this).parent().hide()">
								Add More
							</button>
						</div> --}}
					</div>
					<div class="row" style="display: none;" id="image-row-3">
						<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
							<div class="drop-zone" style="position: relative;">
								<span class="drop-zone__prompt">
									<button class="btn btn-info" type="button">Upload</button>
									...
									<div id="full-stars-example-two">
										<div class="rating-group">
											@for($rating = 0; $rating <= 5; $rating++) @if($rating> 0)
												...
												@endif
												<input class="rating__input {{ $rating === 0 ? 'rating__input--none' : '' }}" name="transaction" id="transaction-{{ $rating }}" value="{{ $rating }}" type="radio" {{ $rating === 0 ? 'disabled checked' : ($rating == old('transaction') ? 'checked' : NULL) }}>
												@endfor
										</div>
									</div>
								</div>
										...
										<div class="row">
											...
											<div class="col-md-12 text-center" style="padding-top:30px;">
												<button type="button" class="btn btn-success crop_image">Crop & Upload
													Image</button>
												<button type="button" class="btn btn-secondary btn-modal-hide" style="margin-left: 2%">Close</button>
											</div>
										</div>
									</div>
...
<script type="text/javascript">
	...
	function mainUploadClick() {
		...
		setTimeout(() => {
			...
			$('#post-images-2').parents('.col-md-4').hide();
			$('#post-images-3').parents('.col-md-4').hide();

			$('#post-images-1').parents(".col-xs-12").removeClass("col-lg-4");
			$('#post-images-1').parents(".col-xs-12").removeClass("col-md-4");
			$('#post-images-1').parents(".col-xs-12").addClass("col-lg-12");
			$('#post-images-1').parents(".col-xs-12").addClass("col-md-12");
			$('#post-images-1').parents(".drop-zone").css('max-width', '100%');
			$('#post-images-1').parents(".drop-zone").css('height', '450px');
			$(".upload-info").hide();
			$(".upload-info").parent().removeClass('artistcol');
		}, 1000);
	}
	...
	function addMoreFirst() {
		$('#post-images-2').parents('.col-xs-12').show();
		$('#post-images-3').parents('.col-xs-12').show();
		$(this).parent().hide();
		$('#add-more-div-1').hide();
		$("#image-row-2").show();
		$("#image-row-3").show();
		// $('#add-more-div-1-2').show();

		$('#post-images-1').parents(".col-xs-12").addClass("col-lg-4");
		$('#post-images-1').parents(".col-xs-12").addClass("col-md-4");
		$('#post-images-1').parents(".col-xs-12").removeClass("col-lg-12");
		$('#post-images-1').parents(".col-xs-12").removeClass("col-md-12");
		$('#post-images-1').parents(".drop-zone").css('max-width', '200px');
		$('#post-images-1').parents(".drop-zone").css('height', '200px');
	}
</script>
@endpush
