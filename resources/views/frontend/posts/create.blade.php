                        ...
                        <div class="post-details">
                            ...
                            <div class="feedback">
                                ...
                                <div class="feedback-op">
                                    <a class="btn btndarkyellow">No</a>
                                    <a class="btn btngreen">Yes</a>
                                </div>
                            </div>
                            <div class="note">
            ...
            <div class="col-lg-2">
                <div class="thumbnailbox">
                    <div class="upload-thumb">
                        ...
                        <input type="file">
                        <img src="{{ asset('assets/images/upload-image.png') }}" alt="Upload image" width="229" height="228" />
                    ...
                    <div class="maturitybox">
                        ...
                        <div class="maturityrating">
                            <input class="maturityrating_input" type="radio" name="maturity-rating" value="option1"
                                id="general">
                            <label for="general">General</label>
                        </div>
                        <div class="maturityrating">
                            <input class="maturityrating_input" type="radio" name="maturity-rating" value="option2"
                                id="mature">
                    ...
                    <div class="post-submit">
                        <a href="" class="btn btngreen">submit</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <form action="">
                            <div class="post-details">
                                ...
                                <div class="input-group hashtag">
                                    <select class="keywords-multiple" name="keywords[]" multiple="multiple"
