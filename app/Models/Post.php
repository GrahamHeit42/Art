...
class Post extends Model
{
    ...
    protected $fillable = [
        'id', 'user_id', 'user_type', 'artist_type', 'drawn_by', 'commisioned_by', 'subject_id', 'medium_id', 'title', 'description', 'keywords', 'c_price', 'c_speed', 'c_quality', 'c_communication', 'c_work_again', 'a_transaction', 'a_concept', 'a_understanding', 'a_communication', 'a_work_again', 'status', 'delete_at'
    ];
